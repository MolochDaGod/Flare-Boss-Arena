...
import { useGetCharacterSkills, type Skill } from "@workspace/api-client-react";
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 h-full">
                ...
                <CardContent className="p-0 flex-1">
                  <ScrollArea className="h-full">
                    <div className="p-4 space-y-4">
                      {skills?.activeSkills?.length ? skills.activeSkills.map((skill: Skill) => (
              ...
              <Card className="border-border/50 bg-card/80 backdrop-blur flex flex-col">
                ...
                <CardContent className="p-0 flex-1">
                  <ScrollArea className="h-full">
                    <div className="p-4 space-y-4">
                      {skills?.passives?.length ? skills.passives.map((skill: Skill) => (
