 ...
 *  - CraftPix spellbook path (`ui/craftpix/spellbook/…`)
...
export function skillIconSrc(icon?: string | null): string | null {
  ...
  // CraftPix spellbook pack (product 172265) — local public assets
  if (path.startsWith("ui/craftpix/spellbook/")) return `${BASE}/${path}`;
