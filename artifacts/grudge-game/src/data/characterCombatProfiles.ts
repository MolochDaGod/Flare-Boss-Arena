...
const BASE_COMBAT_PROFILES: CombatProfile[] = [
  ...
  P(
    ...
    5,
    [
      ab("cleave", "Corsair Cleave", ["attack", "combo"], "physical", "cone", 1.8, 2.8, "Greatsword cone"),
      ab("mind_shot", "Mind Shot", ["cast", "attack"], "psychic", "line", 2.5, 7.0, "Pistol psychic line"),
      ab("psychic_push", "Psymic Push", ["cast", "punch"], "psychic", "circle", 5.0, 5.5, "Green telekinetic ring"),
      ab("hammer", "Keeper's Hammer", ["hammer", "combo"], "physical", "circle", 5.0, 3.5, "Overhead smash"),
      ab("crown", "Psymic Crown", ["cast", "attack"], "psychic", "line", 9.5, 6.0, "Ultimate mind-lance"),
    ],
    true,
  ),
];
