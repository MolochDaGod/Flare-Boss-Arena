...
/** Toon soldier class ΓåÆ rifle/pistol pack (chicken_gun multipack). */ export type ToonSoldierClass =   | "scout"   | "engineer"   | "gunner"   | "infantry"   | "medic"   | "sniper";  export const TOON_SOLDIER_PACK: Record<ToonSoldierClass, BakedAnimPack> = {   scout: "pistol",   engineer: "rifle",   gunner: "rifle",   infantry: "rifle",   medic: "pistol",   sniper: "rifle", };  export const TOON_SOLDIERS_CDN =   "https://assets.grudge-studio.com/models/toon-soldiers";  export function toonSoldierGlbUrl(   cls: ToonSoldierClass,   variant: "a" | "b" = "a", ): string {   return `${TOON_SOLDIERS_CDN}/${cls}/${cls}-${variant}.glb`; }  export function animPackForToonClass(cls: ToonSoldierClass): BakedAnimPack {   return TOON_SOLDIER_PACK[cls] ?? "rifle"; }  /** Toon gameplay modes including Mixamo-retargeted packs. */ export type ToonWeaponMode =   | "pistol"   | "rifle"   | "shooter"   | "longbow"   | "adventure"   | "native";  export const TOON_CLASS_DEFAULT_MODE: Record<ToonSoldierClass, ToonWeaponMode> = {   scout: "pistol",   engineer: "rifle",   gunner: "rifle",   infantry: "shooter",   medic: "pistol",   sniper: "rifle", };  /** Longbow attack/dodge set for Nexus Era bows on toon characters. */ export const TOON_LONGBOW_CLIPS = {   idle: "longbow/standing idle 01",   walk: "longbow/standing walk forward",   run: "longbow/standing run forward",   attack: "longbow/standing aim recoil",   dodge: "longbow/standing dodge forward",   dodgeBack: "longbow/standing dodge backward",   dodgeLeft: "longbow/standing dodge left",   dodgeRight: "longbow/standing dodge right",   draw: "boxanimations/longbow/Standing Draw Arrow (1)",   aimIdle: "boxanimations/longbow/Standing Aim Idle 02 Looking", } as const;  /** Adventure traversal blends ΓÇö Mixamo swim family + climb/crouch. */ export const TOON_ADVENTURE_CLIPS = {   climb: "boxanimations/traversal/Climbing To Top",   climbDown: "boxanimations/traversal/Climbing Down Wall",   swim: "locomotion/swimming",   swimIdle: "locomotion/treading-water",   swimToLedge: "locomotion/swimming-to-ledge",   crouch: "boxanimations/locomotion/Crouch Walk",   sneak: "boxanimations/locomotion/Sneak Walk",   jump: "locomotion/jump",   dodge: "locomotion/dodging",   roll: "boxanimations/locomotion/Quick Roll To Run (1)", } as const;  export function toonLongbowUrl(rel: keyof typeof TOON_LONGBOW_CLIPS): string {   return bakedAnimUrl(TOON_LONGBOW_CLIPS[rel]); }  export function toonAdventureUrl(rel: keyof typeof TOON_ADVENTURE_CLIPS): string {   return bakedAnimUrl(TOON_ADVENTURE_CLIPS[rel]); }  /** Base human height (m) ΓÇö multiplied by per-race scale (grudge-arena RaceConfig). */ export const GRUDGE6_BASE_HEIGHT = 1.75;  export const RACE_HEIGHT_SCALE: Record<RaceId, number> = {   human: 1.0,   barbarian: 1.12,   elf: 1.05,   dwarf: 0.85,   orc: 1.08,   undead: 0.95, };  export function targetHeightForRace(race: RaceId): number {   return GRUDGE6_BASE_HEIGHT * (RACE_HEIGHT_SCALE[race] ?? 1); }
