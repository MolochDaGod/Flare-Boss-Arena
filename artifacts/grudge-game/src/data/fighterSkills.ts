...
const KITS: FighterKit[] = [
  ...
  },
  {
    ...
    special: {
      ...
      description: "A Conqueror's-clad sword wave that cuts the horizon.",
      anim: ["skill_a", "skill_b", "combo_c"],
      damageMult: 3.0,
      manaCost: 32,
      cooldown: 9,
  ...
  },
  {
    ...
    special: {
      name: "Rokuogan",
      description: "A point-blank shockwave fist that blasts forward.",
    ...
    skills: [
      sk({ id: "shigan", name: "Shigan", description: "Finger pistol line strike.", glyph: "👉", anim: ["combo_a"], targeting: "instant", shape: "line", element: "physical", damageMult: 1.6, manaCost: 10, cooldown: 2 }),
      sk({ id: "rankyaku", name: "Rankyaku", description: "Flying kick slash wave.", glyph: "🦵", anim: ["combo_b", "skill_a"], targeting: "slash_wave", shape: "slash", element: "physical", damageMult: 1.9, manaCost: 16, cooldown: 3.5, slashRange: 11, color: 0xccddff }),
      sk({ id: "geppo", name: "Geppo Assault", description: "Air-step into a ground nova.", glyph: "☁", anim: ["jump", "combo_c"], targeting: "ground_aoe", shape: "nova", element: "physical", damageMult: 2.0, manaCost: 18, cooldown: 5, aoeRadius: 4.5, placeRange: 8 }),
      sk({ id: "tekkai", name: "Tekkai Counter", description: "Harden then explode outward.", glyph: "🛡", anim: ["boost", "skill_b"], targeting: "instant", shape: "nova", element: "physical", damageMult: 1.7, manaCost: 14, cooldown: 4, aoeRadius: 4 }),
      sk({ id: "life_return", name: "Life Return Leopard", description: "Beast-form claw AoE.", glyph: "🐆", anim: ["skill_b", "combo_e"], targeting: "ground_aoe", shape: "circle", element: "physical", damageMult: 2.4, manaCost: 28, cooldown: 8, aoeRadius: 5, placeRange: 7 }),
    ],
  },
  {
  ...
  },
  {
    fighterId: "shiryu",
    special: {
      name: "Clear-Clear Thrust",
      description: "Invisible blade wave from the rain.",
      anim: ["skill_a", "skill_b", "combo_c"],
      damageMult: 2.8,
      manaCost: 28,
      cooldown: 8,
  ...
  },
  {
    ...
    special: {
      name: "Honesty Impact",
      description: "A sincere shockwave punch that races outward.",
      anim: ["0062", "0063", "combo"],
      damageMult: 2.3,
      manaCost: 24,
      cooldown: 7,
      element: "physical",
    ...
    skills: [
      sk({ id: "jab", name: "Marine Jab", description: "Basic punch cone.", glyph: "👊", anim: ["0062", "combo"], targeting: "instant", shape: "cone", element: "physical", damageMult: 1.3, manaCost: 6, cooldown: 1.2, aoeRadius: 3.5 }),
      sk({ id: "charge", name: "Honesty Charge", description: "Line rush.", glyph: "🏃", anim: ["0110", "0063"], targeting: "instant", shape: "line", element: "physical", damageMult: 1.6, manaCost: 12, cooldown: 3 }),
      sk({ id: "shock", name: "Fist Shock", description: "Ground circle shock.", glyph: "💫", anim: ["0063", "0062"], targeting: "ground_aoe", shape: "circle", element: "lightning", damageMult: 1.9, manaCost: 18, cooldown: 5, aoeRadius: 4, placeRange: 8 }),
      sk({ id: "rally", name: "Rally Cry", description: "Self buff nova.", glyph: "📢", anim: ["0011", "boost"], targeting: "self", shape: "nova", element: "arcane", damageMult: 0.5, manaCost: 14, cooldown: 6, aoeRadius: 3 }),
      sk({ id: "rising", name: "Rising Star", description: "Leap smash AoE.", glyph: "⭐", anim: ["0063", "0062_Low"], targeting: "ground_aoe", shape: "nova", element: "physical", damageMult: 2.2, manaCost: 22, cooldown: 7, aoeRadius: 5, placeRange: 7 }),
    ],
  },
  {
    fighterId: "mihawk",
  ...
  },
  {
    ...
    special: {
      name: "Boro Breath",
      description: "Dragon thunder breath — a devastating fire-lightning wave.",
  ...
  },
  {
    ...
    special: {
      ...
      description: "A greatblade wave of the Corsair King.",
      anim: ["hammer", "combo", "attack"],
      damageMult: 2.9,
      manaCost: 30,
      cooldown: 8,
      element: "physical",
    ...
    skills: [
      sk({ id: "cleave", name: "Corsair Cleave", description: "Wide blade cone.", glyph: "⚔", anim: ["attack", "slash"], targeting: "instant", shape: "cone", element: "physical", damageMult: 1.7, manaCost: 10, cooldown: 1.8, aoeRadius: 5 }),
      sk({ id: "hammer", name: "Keeper's Hammer", description: "Overhead ground smash.", glyph: "🔨", anim: ["hammer", "combo"], targeting: "ground_aoe", shape: "circle", element: "physical", damageMult: 2.2, manaCost: 20, cooldown: 5, aoeRadius: 4.5, placeRange: 8 }),
      sk({ id: "wave", name: "Tide Cut", description: "Horizontal slash wave.", glyph: "🌊", anim: ["combo", "attack"], targeting: "slash_wave", shape: "slash", element: "physical", damageMult: 2.0, manaCost: 16, cooldown: 4, slashRange: 12, color: 0xd4b06a }),
      sk({ id: "shout", name: "Warlord Shout", description: "Intimidate nova.", glyph: "📢", anim: ["shout", "cast"], targeting: "instant", shape: "nova", element: "arcane", damageMult: 1.5, manaCost: 14, cooldown: 5, aoeRadius: 6 }),
      sk({ id: "judgment", name: "Pirate Judgment", description: "Massive ground judgment.", glyph: "⚖", anim: ["hammer", "punch"], targeting: "ground_aoe", shape: "nova", element: "arcane", damageMult: 2.6, manaCost: 32, cooldown: 10, aoeRadius: 6, placeRange: 9 }),
    ],
  },
];
