...
import { getActiveFighter, RACALVIN_ID, SCOURGE_ID, JOHN_WAYNE_ID } from "./fighters";
...
const KITS: FighterKit[] = [
  ...
  {
    fighterId: SCOURGE_ID,
    special: {
      name: "Reef Crush",
      description: "Throw the chain-anchor, then slam the reel-in for a crushing ground nova.",
      anim: ["slam", "skill3"],
      damageMult: 3.0,
      manaCost: 32,
      cooldown: 9,
    ...
    skills: [
      sk({
        id: "anchor_throw",
        name: "Anchor Throw",
        description: "Fling Cryoshard warpick on the chain — mid-range line hit.",
        glyph: "⚓",
        anim: ["skill1", "attack", "slash"],
        targeting: "instant",
        shape: "line",
        element: "physical",
        damageMult: 1.75,
      ...
      sk({
        id: "chain_yank",
        name: "Chain Yank",
        description: "Reel the chain back — cone pull + damage toward you.",
        glyph: "⛓",
        anim: ["skill2", "combo"],
        targeting: "instant",
        shape: "cone",
      ...
      sk({
        id: "reaping_swing",
        name: "Reaping Swing",
        description: "Wide mid-range chain arc.",
        glyph: "🌑",
        anim: ["combo", "slash"],
        targeting: "instant",
        shape: "cone",
      ...
      sk({
        id: "ground_slam",
        name: "Harbor Slam",
        description: "Plant the anchor and quake the deck.",
        glyph: "💥",
        anim: ["slam", "skill3"],
      ...
      sk({
        id: "faith_bulwark",
        name: "Faith Bulwark",
        description: "Tank stance shockwave — short self nova.",
        glyph: "🛡",
        anim: ["skill3", "slam"],
        targeting: "ground_aoe",
        shape: "nova",
  ...
  {
    fighterId: JOHN_WAYNE_ID,
    special: {
      name: "Pathfinder Barrage",
      description: "Spin-up gadget volley — 360 engineer devastation.",
      anim: ["special", "charge"],
      damageMult: 2.85,
      manaCost: 30,
      cooldown: 8,
    ...
    skills: [
      sk({
        id: "field_snipe",
        name: "Field Snipe",
        description: "Long-range engineer line shot.",
        glyph: "🎯",
        anim: ["attack", "cast"],
        targeting: "instant",
        shape: "line",
      ...
      sk({
        id: "gadget_mine",
        name: "Gadget Mine",
        description: "Place a proximity charge (ground AoE).",
        glyph: "💣",
        anim: ["cast", "combo"],
        targeting: "ground_aoe",
        shape: "circle",
      ...
      sk({
        id: "turret_burst",
        name: "Turret Burst",
        description: "Deploy portable turret cone fire.",
        glyph: "🔧",
        anim: ["combo2", "slash"],
        targeting: "instant",
        shape: "cone",
      ...
      sk({
        id: "path_charge",
        name: "Path Charge",
        description: "In-place forward charge burst.",
        glyph: "⚡",
        anim: ["charge", "combo"],
        targeting: "instant",
        shape: "line",
      ...
      sk({
        id: "shout_calibrate",
        name: "Calibrate Shout",
        description: "Team buff pulse + light damage ring.",
        glyph: "📣",
        anim: ["cast", "special"],
        targeting: "ground_aoe",
        shape: "circle",
